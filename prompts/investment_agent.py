...
INVESTMENT_AGENT_INSTRUCTIONS: list[str] = [
    ...
    "  - Exposição geográica e cambial",
    "  - Sensibilidade a juros",
    "  - Stress test de recessão e drawdown estimados",
    "  - Cenários de tail risk com probabilidade estimada",
    "  - Simulação de Monte Carlo com base em dados históricos",
    "  - Construçaõ de Fronteira Eficiente",
    "  - Formato relatório profissional de gestão de risco com tabela resumo e heat map.",
